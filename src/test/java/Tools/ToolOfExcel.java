...
//            provSelect.selectByValue(String.valueOf(i));
    ...
    @Test
    void getKFCStation() throws Exception{
...
//           如果rowCount为0,意味着根本没有KFC在这里自然不用看了
    ...
    void getStarBuckStation() throws Exception{
        ...
        ExcelUtil.exportExcel(folderPath1+"OriginalStarBuckStationNum.xlsx",allStarBuckStationNum,StarBuckStationNum.class);
    }
    @Test
...
//        选择"省份-城市-县区"列表
        List<WebElement> es0 =  webDriver.findElements(By.cssSelector(".LocationFilterPanel > div.LocationFilterTabs > button"));
